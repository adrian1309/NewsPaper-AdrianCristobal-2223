...
@WebListener
public class ThymleafListener implements ServletContextListener, HttpSessionListener, HttpSessionAttributeListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        sce.getServletContext().setAttribute(Constants.TEMPLATE_ENGINE_ATTR, templateEngine);
    }
    ...
    private WebApplicationTemplateResolver templateResolver(IWebApplication application) {
        ...
        templateResolver.setPrefix(Constants.PATH_PREFIX);
        templateResolver.setSuffix(Constants.PATH_SUFFIX);
